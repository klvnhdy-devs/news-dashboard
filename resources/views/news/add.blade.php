...
<div class="toastify on  toastify-right toastify-top" style="transform: translate(0px, 0px); top: 15px;">
    <div id="success-notification-content" class="toastify-content flex"> <i class="text-success" data-lucide="check-circle"></i>
        <div class="ml-4 mr-4">
            <div class="font-medium">Berhasil Tambah Data!</div>
        </div>
            ...
            <form action="{{ route('news.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
                    ...
                    <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                        <div class="dropdown">
                            <button type="submit" class="dropdown-toggle btn btn-primary shadow-md flex items-center" aria-expanded="false" data-tw-toggle="dropdown"> Save <i class="w-4 h-4 ml-2" data-lucide="chevron-down"></i> </button>
                        </div>
                    </div>
                </div>
                <div class="pos intro-y grid grid-cols-12 gap-5 mt-5">
                    <!-- BEGIN: Post Content -->
                        ...
                        <div class="intro-y col-span-12 lg:col-span-8">
                            <input type="text" name="title" value="{{old('title')}}" required class="intro-y form-control py-3 px-4 box pr-10" placeholder="Title">
                            <input type="text" name="short_desc" value="{{old('short_desc')}}" required class="intro-y form-control py-3 px-4 box pr-10 mt-5" placeholder="Short Description">
                                ...
                                <div class="post__content tab-content">
                                    <div id="content" class="tab-pane p-5 active" role="tabpanel" aria-labelledby="content-tab">
                                        <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                                            ...
                                            <div class="mt-5">
                                                <textarea name="desc" id=""  class="editor" >{{old('desc')}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-span-12 lg:col-span-4">
                            <div class="intro-y box p-5">
                                ...
                                <div class="mt-3">
                                    ...
                                    <input type="text" class="datepicker form-control" id="post-form-2" data-single-mode="true" disabled>
                                </div>
                            </div>
                        </div>
                        <!-- END: Post Info -->
